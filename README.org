...
***** Make changes to ~postgresql.conf~ for standby
...
**** TODO via WAL Archival (PITR) (TODO)
I've not done this yet, will update when I get an opportunity to play around with it. But this is extremely similar to standby servers except the following gotchas/differences:
